...
书桌为常规大小（约 1.1 米 \* 0.6 米左右）。桌上无台灯，需自备。

### 2. 打印 & 复印: <a href="#id-2-da-yin-fu-yin" id="id-2-da-yin-fu-yin"></a>

Hall 内有打印机（可黑白可彩色），位于一楼 co-working space，使用方法与学校打印机一致。
...
### 1.自习室 <a href="#id-1-zi-xi-shi" id="id-1-zi-xi-shi"></a>

Hall 内有两间学习室。

### 2. 活动室 <a href="#id-2-huo-dong-shi" id="id-2-huo-dong-shi"></a>
