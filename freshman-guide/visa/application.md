...
<figure><img src="../../.gitbook/assets/aa2f9ea0e29220f9fe30899f9bf8b473.png" alt="" width="486"><figcaption></figcaption></figure>
{% endstep %}
...
<figure><img src="../../.gitbook/assets/image (25).png" alt="" width="431"><figcaption></figcaption></figure>
{% endstep %}
...
**“签署”、"Signature"** 是指本人签名。对中/英文、简/繁体字、是否连笔、是否能够辨认出姓名等均无要求。但是，避免使用电子输入姓名、电子签署等。
{% endhint %}
...
7. **财产证明（Financial Proof）**
   ...
   * 根据 AO 官网，入境事务处将对财产证明有严格要求。申请人或其财政资助人须有足够能力支付学费和留港日常生活费用。申请人须提交**下列其中一项文件**作为财政证明：
     ...
     3. 经济援助或奖学金的奖励函（Award Letter）。
        * 如同学仅获得全额**学费**奖学金，仍需提交额外的财务证明文件，以支持在香港的**生活开支**。
   * 财产证明并未设定最低存款金额要求。根据过往经验，申请人应持有约人民币 100,000 - 150,000 元。

{% hint style="info" %}
**RIC 建议一般使用存款证明，而不使用工资单。**
